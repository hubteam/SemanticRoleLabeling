 ...
 *
 */
public class SRLEvaluatorForByStepNotNullLabel extends Evaluator<SRLSample<HeadTreeNode>>{

	private SRLMEForIdentification taggerIden;
	private SRLMEForClassificationNotNullLabel taggerClas;
	private SRLMeasure measure;
	
	public SRLEvaluatorForByStepNotNullLabel(SRLMEForIdentification taggerIden,SRLMEForClassificationNotNullLabel taggerClas) {
		this.taggerIden = taggerIden;
		this.taggerClas = taggerClas;
	}
	
	public SRLEvaluatorForByStepNotNullLabel(SRLMEForIdentification taggerIden,SRLMEForClassificationNotNullLabel taggerClas,SRLEvaluateMonitor... evaluateMonitors) {
	...
	protected SRLSample<HeadTreeNode> processSample(SRLSample<HeadTreeNode> sample) {
		...
		System.out.println();
		measure.update(labelinfoClasRef, labelinfoClasPre);
