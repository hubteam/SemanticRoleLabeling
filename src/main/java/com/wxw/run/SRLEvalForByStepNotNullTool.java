 ...
 *
 */
public class SRLEvalForByStepNotNullTool {
	private static void usage(){
		System.out.println(SRLEvalForByStepNotNullTool.class.getName() + 
	...
	public static void eval(File trainFile, AbstractParseStrategy<HeadTreeNode> parse, TrainingParameters params, File goldFile, String encoding, File errorFile) throws IOException{
		...
		SRLModelForClassification modelClas = meClas.train(trainFile,params, contextGenClas, encoding);	
        System.out.println("训练时间： " + (System.currentTimeMillis() - start));
        SRLMEForIdentification taggerIden = new SRLMEForIdentification(modelIden,contextGenIden,parse);
        SRLMEForClassificationNotNullLabel taggerClas = new SRLMEForClassificationNotNullLabel(modelIden,modelClas,contextGenIden,contextGenClas,parse);
