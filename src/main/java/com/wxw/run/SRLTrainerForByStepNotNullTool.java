 ...
 *
 */
public class SRLTrainerForByStepNotNullTool {
    //parse指示文本解析的方式，共四种
	//normal  normalprune addnull addnullprune
	private static void usage(){
		System.out.println(SRLTrainerForByStepNotNullTool.class.getName()+"-data <corpusFile> -idenmodel <idenmodelFile> -clasmodel <clasmodelFile> -parse <parsetype> -type <algorithom>"
	...
	public static void main(String[] args) throws IOException {
		...
		meIden.train(corpusFile, idenmodelFile, params, contextGenIden, encoding);

		SRLMEForClassificationNotNullLabel meClas = new SRLMEForClassificationNotNullLabel(parse);
        meClas.train(corpusFile, clasmodelFile, params, contextGenClas, encoding);
	}	
}
