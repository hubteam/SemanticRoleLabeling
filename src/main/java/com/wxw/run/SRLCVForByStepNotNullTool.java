 ...
 *
 */
public class SRLCVForByStepNotNullTool {
    ...
    public SRLCVForByStepNotNullTool(String languageCode,TrainingParameters trainParam,SRLEvaluateMonitor... listeners){
    ...
    public void evaluate(ObjectStream<SRLSample<HeadTreeNode>> samples, AbstractParseStrategy<HeadTreeNode> parse, int nFolds,SRLContextGenerator contextIden, SRLContextGenerator contextClas) throws IOException{
		...
		while(partitioner.hasNext()){
			...
			SRLModelForClassification modelClas = meClas.train(languageCode, trainingSampleStream, params, contextClas);
    ...
    public static void main(String[] args) throws IOException {
        ...
        SRLCVForByStepNotNullTool run = new SRLCVForByStepNotNullTool("zh",params);
