...
//		result1 = "(S(NP-SBJ{ARG0}(NP(NNP Pierre_[0])(NNP Vinken_[1]))(, ,_[2])(ADJP(NP(CD 61_[3])(NNS years_[4]))(JJ old_[5]))(, ,_[6]))(VP(MD{ARGM-MOD} will_[7])(VP(VB{rel} join_[8])(NP{ARG1}(DT the_[9])(NN board_[10]))(PP-CLR{ARGM-PRD}(IN as_[11])(NP(DT a_[12])(JJ nonexecutive_[13])(NN director_[14])))(NP-TMP{ARGM-TMP}(NNP Nov._[15])(CD 29_[16]))))(. ._[17]))";
...
//		result3 = "(S(NP-SBJ-1{ARG1}(NP(NNS Yields_[0]))(PP(IN on_[1])(NP(JJ money-market_[2])(JJ mutual_[3])(NNS funds_[4]))))"
//				+ "(VP(VBD{rel} continued_[5])(S{ARG1}(NP-SBJ(-NONE- *-1_[6]))(VP(TO to_[7])(VP(VB slide_[8]))))(, ,_[9])"
//				+ "(PP-LOC{ARGM-MNR}(IN amid_[10])(NP(NNS signs_[11])(SBAR(IN that_[12])"+
//				"(S(NP-SBJ(NN portfolio_[13])(NNS managers_[14]))(VP(VBP expect_[15])"
//				+ "(NP(NP(JJ further_[16])(NNS declines_[17]))(PP-LOC(IN in_[18])(NP(NN interest_[19])"
//				+ "(NNS rates_[20]))))))))))(. ._[21]))";
...
//		result4 = "(S(NP-SBJ(NP{ARG1}(NNS Sales_[0]))(PP{ARG1}(IN of_[1])(NP(JJ medium-sized_[2])(NNS cars_[3])))(, ,_[4])(SBAR(WHNP-21{ARG1}(WDT which_[5]))"+
...
//				"(NNS units_[24])))(PP-DIR(IN from_[25])(NP(CD 13,056_[26]))(PP-TMP(IN in_[27])(NP(NNP October_[28])(CD 1988_[29])))))(. ._[30]))";
	...
	@Test
	public void test(){
		assertEquals(roletree1.toString(),result1);
		assertEquals(roletree2_1.toString(),result2_1);
		assertEquals(roletree2_2.toString(),result2_2);
		assertEquals(roletree3.toString(),result3);
		assertEquals(roletree4.toString(),result4);
	}
}
